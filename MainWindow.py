...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.image_view = QtGui.QLabel(self.frame_2)
        ...
        self.current_image_index_label = QtGui.QLabel(self.frame_2)
        self.current_image_index_label.setMaximumSize(QtCore.QSize(16777215, 20))
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.search_term_text_box.sizePolicy().hasHeightForWidth())
        self.search_term_text_box.setSizePolicy(sizePolicy)
        self.search_term_text_box.setFrame(True)
        self.search_term_text_box.setCursorPosition(0)
        self.search_term_text_box.setPlaceholderText(_fromUtf8(""))
        self.search_term_text_box.setObjectName(_fromUtf8("search_term_text_box"))
        self.verticalLayout_2.addWidget(self.search_term_text_box)
        ...
        self.num_images_text_box = QtGui.QLineEdit(self.frame_4)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.num_images_text_box.sizePolicy().hasHeightForWidth())
        self.num_images_text_box.setSizePolicy(sizePolicy)
        self.num_images_text_box.setObjectName(_fromUtf8("num_images_text_box"))
        self.verticalLayout_3.addWidget(self.num_images_text_box)
        self.horizontalLayout.addWidget(self.frame_4)
        self.search_button = QtGui.QPushButton(self.frame_5)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.search_button.sizePolicy().hasHeightForWidth())
        self.search_button.setSizePolicy(sizePolicy)
        self.search_button.setMaximumSize(QtCore.QSize(200, 200))
        self.search_button.setObjectName(_fromUtf8("search_button"))
        self.horizontalLayout.addWidget(self.search_button)
        self.gridLayout_2.addWidget(self.frame_5, 2, 0, 1, 3)
        self.saved_images_count_label = QtGui.QLabel(self.frame)
        self.saved_images_count_label.setObjectName(_fromUtf8("saved_images_count_label"))
        self.gridLayout_2.addWidget(self.saved_images_count_label, 6, 2, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.saved_url, 7, 0, 1, 3)
        self.loaded_url = QtGui.QListWidget(self.frame)
        self.loaded_url.setObjectName(_fromUtf8("loaded_url"))
        self.gridLayout_2.addWidget(self.loaded_url, 8, 0, 1, 3)
        self.saved_images_count_text = QtGui.QLabel(self.frame)
        self.saved_images_count_text.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.saved_images_count_text.setObjectName(_fromUtf8("saved_images_count_text"))
        self.gridLayout_2.addWidget(self.saved_images_count_text, 6, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.save_button, 0, 0, 2, 1)
        ...
        self.gridLayout_2.addWidget(self.delete_button, 0, 1, 2, 1)
        ...
        self.gridLayout_2.addWidget(self.save_dir_button, 0, 2, 2, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.saved_images_count_text.setText(_translate("MainWindow", "Number of saved Images:", None))
